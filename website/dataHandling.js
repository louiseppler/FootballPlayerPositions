...
const gameEvents = {
	...
	"GOAL"		: {res: 9, icon: "goal", letter: "G"},
	"GOAL KICK"	: {res: 4, icon: "freekick", letter: "GK"},
	...
	"YELLOW"	: {res: 9, icon: "yellow", letter: "YELLOW"},
}